...
function Profile() {
  ...
  // 🔑 Cloudinary Credentials (এখানে আপনার কপি করা তথ্যগুলো বসান)
  const CLOUDINARY_CLOUD_NAME = "lqlwnjie"; // 👈 আপনার Cloud Name দিন
  const CLOUDINARY_UPLOAD_PRESET = "eduvault_preset"; // 👈 আপনার Unsigned Preset Name দিন
  ...
  // 🔥 Upload Image to Cloudinary & Update Firebase Profile Photo
  const handleUploadPhoto = async (e) => {
    ...
    try {
      ...
      console.log("Cloudinary Response:", data); // Console-এ রেসপন্স চেক করার জন্য

      if (data.secure_url) {
        const imageUrl = data.secure_url;

        // Firebase Auth Profile Photo Update
        await updateProfile(user, {
          photoURL: imageUrl,
        });
        ...
        alert(`Upload failed: ${data.error?.message || "Invalid Cloud Name or Preset"}`);
      }
    } catch (error) {
      console.error("Error uploading photo to Cloudinary:", error);
      alert("Network or Upload Error! Please check console.");
    } finally {
      setUpdatingPhoto(false); // ঝুলন্ত অবস্থা বন্ধ করবে
    }
  };
    ...
    >
      ...
      <div className="card-style relative p-10">
          ...
          {isEditingPhoto && (
            ...
            >
              ...
              <div className="flex w-full gap-2">
                ...
                >
                  {updatingPhoto ? "Uploading to Cloudinary..." : "Upload Photo"}
                </button>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <motion.div whileHover={{ y: -5 }} className="card-style p-6 transition-all">
