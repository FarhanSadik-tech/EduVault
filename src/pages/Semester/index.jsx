...
function Semester() {
  ...
  // Force 12 Semesters generation regardless of departments.js configuration
  const semestersCount = department.semesters || 12 < 12 ? 12 : department.semesters || 12;
        ...
        {semesters.map((semester, index) => {
          ...
          return (
            ...
            <motion.div
              ...
              className="card-style p-8 flex flex-col justify-between"
            >
