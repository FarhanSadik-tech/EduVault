...
function Course() {
  ...
  // 🔥 Firestore থেকে ডাইনামিকালি কোর্স ফেচ করার Hook
  useEffect(() => {
    const fetchCoursesFromFirestore = async () => {
      ...
      try {
        const q = query(
          ...
          where("departmentId", "==", searchData.department.toLowerCase()),
          where("semesterId", "==", searchData.semester.toLowerCase())
        );
  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-16">
      ...
      <div className="text-center">
        <h1 className="text-5xl font-bold text-white">Search Resources</h1>
        <p className="mt-4 text-slate-400">
          Search any question, note, solution, lecture or lab report.
        </p>
      </div>
      ...
      <div className="card-style mt-14 rounded-3xl p-8">
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {/* Keyword Input */}
          <div>
            <label className="mb-2 block text-slate-300">Keyword</label>
            <input
              type="text"
              name="keyword"
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              disabled={!searchData.department || !searchData.semester || loadingCourses}
          ...
          {/* Resource Type Dropdown with Lectures */}
          <div>
            ...
            >
              ...
              <option value="Lectures">Lectures</option> {/* Added Lectures Option */}
      ...
      {loading && (
        <div className="mt-12 text-center">
          <h2 className="text-2xl text-white">Searching...</h2>
        </div>
      )}
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {results.map((resource) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="card-style flex flex-col justify-between p-6"
            >
              <div>
